    ...
    <>
      ...
      <div className="relative z-20 py-16 lg:py-24 bg-black">
        ...
        <div className="max-w-2xl lg:items-center mb-16 flex-col flex lg:flex-row gap-8 lg:gap-4 mx-auto px-8">
          ...
          <div className="flex-1">
            <blockquote className="font-sans text-white mb-2 font-bold uppercase text-2xl">
        ...
        <div className="max-w-2xl text-white items-center mx-auto mb-16 px-8">
          <h2 className="text-3xl mb-8 uppercase font-sans font-bold ">
            Discography
          </h2>
        ...
        <div className="max-w-2xl mx-auto mb-16 px-8">
          <blockquote className="font-sans mb-2 text-white font-bold uppercase text-2xl">
        ...
        <div className="max-w-2xl text-white mx-auto mb-16 px-8">
          <h4 className="text-xl mb-6 uppercase font-sans font-bold text-white">
        ...
        <div className="max-w-2xl text-white mx-auto px-8 mb-16 grid gap-8 grid-cols-1 lg:grid-cols-2">
          <div>
            <CountUp
              from={0}
              to={73641}
        ...
        <div className="max-w-2xl text-white mx-auto px-8 mb-16">
          <h4 className="text-3xl mb-8 uppercase font-sans font-bold ">Team</h4>
